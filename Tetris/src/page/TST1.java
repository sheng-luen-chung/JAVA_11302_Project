...
/**
 * 顯示 T轉消一行 示範畫面，並且可以切換到其他指示畫面。
 * 為整個指示和消行示範的第5頁。
 * <p>
 * 此面板會在 Tetris 主畫面中被切換至 TST1 時啟動。
 * 
 * @author Maple
 * @version 3.02
 */
public class TST1 extends JPanel{
    ...
    public void startPanel() {
    	Tetris.cardLayout.show(Tetris.mainPanel, "TST1");
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawString("T-Spin Single", Tetris.TOTAL_SIZE_X / 2 - 160, 40);
    ...
    private class BNext implements ActionListener {
        public void actionPerformed(ActionEvent e) {
        	Tetris.setPage(Tetris.PAGE_TST2);
        }
    }
